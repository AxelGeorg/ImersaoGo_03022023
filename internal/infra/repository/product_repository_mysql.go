...
func (r *ProductRepositoryMysql) Create(product *entity.Procuct) error {
...
func (r *ProductRepositoryMysql) FindAll() ([]*entity.Procuct, error) {
	...
	var products []*entity.Procuct
	for rows.Next() {
		var product entity.Procuct
